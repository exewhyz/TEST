const data = [
    ...
    {
        "ID": "ConfluenceBasic",
        "ImageUrl": "https://metapercept.com/images/training-certification/Authoring-Tools.jpg",
    ...
    {
        "ID": "XMLAuthor",
        "ImageUrl": "https://metapercept.com/images/training-certification/Simplified-Technical-English.jpg",
        "Name": "XML Author",
    ...
    },
    {
        ...
        "ImageUrl": "https://metapercept.com/images/training-certification/Technical-Writing.jpg",
    ...
    {
        "ID": "AdvancedDITA-XML",
        "ImageUrl": "https://metapercept.com/images/training-certification/Basic-DITA–XML.jpg",
    ...
    <div class="col-3">
        <div class="card" style="margin:20px 0;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">${item.ShortDesc.substring(0,150)+"..."}</p>
                <a href="#" class="btn btn-light btn-outline-dark">View</a>
            </div>
        </div>
    </div>
    `
